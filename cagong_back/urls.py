...
urlpatterns = [
    ...
    path('api/cafe/', cafe_views.CafeListAPIView.as_view(), name='cafe'),
    path('api/cafe/detail/<int:cafe_id>/',
         cafe_views.CafeDetailAPIView.as_view(), name='detail'),
    path('api/getpush/<str:user_id>', pushQue_views.GetPushNotificationAPIView.as_view()),
    path('api/createpush/', pushQue_views.CreatePushNotificationAPIView.as_view()),
